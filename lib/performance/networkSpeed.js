...
var _api = _interopRequireDefault(require("../base/api"));
...
var MonitorNetworkSpeed = /*#__PURE__*/function (_BaseMonitor) {
  ...
  function MonitorNetworkSpeed(options) {
    ...
    _this.category = _baseConfig.ErrorCategoryEnum.NETWORK_SPEED;
      ...
      try {
        ...
        xhr.onreadystatechange = function () {
          ...
          if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            new _api.default(_this3.url).report(data);
          }
        };
...
var _default = MonitorNetworkSpeed;
